    ...
    <nav className="w-full flex items-center justify-between px-4 sm:px-10 lg:px-25 py-3 -mb-6">
      ...
      <div className="flex items-center -ml-7 sm:-ml-15 cursor-default">
        <img
          ...
          alt="CoinShark"
          className="brightness-110 transition will-change-transform duration-600 hover:-rotate-15 w-24 sm:w-50"
        />
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Logout button */}
        <button
          className="text-ink text-sm sm:text-xl flex items-center gap-2 p-2.5 bg-card rounded-2xl shadow border border-gray-200  will-change-transform transition-all duration-600 hover:scale-105 hover:border-danger  hover:text-danger active:scale-95 cursor-pointer"
