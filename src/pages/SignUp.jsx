      ...
      <div className="flex flex-col items-center justify-center rounded-2xl pt-6 px-6 sm:px-12 pb-8 w-full sm:min-w-xl sm:max-w-xl bg-card border border-gray-300 shadow-md">
        ...
        >
          <div className="flex flex-col gap-2 mb-5 w-full">
            ...
            <input
              className="text-lg sm:text-xl rounded-2xl p-3 w-full border-3 border-gray-300 focus:border-accent outline-none hover:border-gray-400 transition duration-500"
              type="email"
          ...
          <button
            className="text-lg sm:text-2xl text-center rounded-2xl bg-accent text-white w-full p-3 mb-3 cursor-pointer transition-all duration-500 hover:scale-102 hover:brightness-105 active:scale-98 disabled:opacity-60"
            type="submit"
          ...
          <button
            type="button"
            className="w-full text-lg sm:text-2xl border-4 rounded-2xl p-3 cursor-pointer transition-all duration-500 hover:scale-102 hover:brightness-105 active:scale-98 flex items-center justify-center border-accent text-accent bg-accent/10"
